  ...
  return (
    <main className="py-12">
      <Container>
        ...
        {/* 2 colonnes dès md, 1 colonne en mobile */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto items-start">
          
          {/* --- Carte Constance --- */}
          <article className="flex flex-col items-center text-center bg-white p-6 rounded-2xl shadow-sm border">
            ...
            <h2 className="text-2xl font-semibold mb-1">Constance Vale</h2>
            <p className="text-gray-700 font-medium mb-3">
              Co-fondatrice & Éducatrice canine
            </p>
          ...
          <article className="flex flex-col items-center text-center bg-white p-6 rounded-2xl shadow-sm border">
            ...
            <h2 className="text-2xl font-semibold mb-1">Marc Kemp</h2>
            <p className="text-gray-700 font-medium mb-3">
              Co-fondateur & Dresseur spécialisé
            </p>
            <p className="text-gray-700 text-sm leading-relaxed max-w-prose">
